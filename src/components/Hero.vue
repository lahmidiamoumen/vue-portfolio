...
<style lang="scss" scoped>
  ...
  .header-image {
    ...
    background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.9)),url('https://res.cloudinary.com/samrose3/image/upload/q_auto:eco/v1507668120/good-vibes.webp');
